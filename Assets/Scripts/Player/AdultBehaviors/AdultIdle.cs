...
public class AdultIdle : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        else if (!adult.IsGrounded() && adultRb.velocity.y > 0)
        {
            animator.SetInteger("AdultState", 3);
        }
        else if (!adult.IsGrounded() && adultRb.velocity.y < 0.1f)
        {
            animator.SetInteger("AdultState", 5);
        }
    }
